...
const NPD_GATE_STANDARDS: Record<string, SOPGateStandard> = {
  concept: {
    ...
    responsibleRoles: ['产品经理负责产品定义、材料与结论', 'R&D Lead 负责技术可行性', 'Finance/SCM 负责成本与供应风险', '管理层/Owner 负责立项决策'],
  ...
  planning: {
    ...
    responsibleRoles: ['产品经理负责需求、PRD 和范围取舍', '项目经理/PMO 负责里程碑、资源和关键路径', 'R&D 负责规格可实现性', 'SCM 负责关键料件与供应商', '管理层/Owner 负责 Kickoff 决策'],
  ...
  design: {
    ...
    responsibleRoles: ['R&D Lead 负责设计完整性', '产品经理负责范围取舍和产品体验', '项目经理/PMO 负责节奏、风险和跨部门推进', 'QA/ME 负责可验证性与可制造性', '管理层/Owner 负责设计冻结批准'],
  ...
  pvt: {
    ...
    responsibleRoles: ['ME/工厂负责试产执行', 'QA 负责质量判定', 'SCM 负责物料与供应', '项目经理/PMO 负责发布准备推进', '产品经理/管理层负责 MP Release 决策'],
...
const JDM_GATE_STANDARDS: Record<string, SOPGateStandard> = {
  ...
  pvt: {
    ...
    responsibleRoles: ['ME/工厂负责试产执行', 'QA 负责质量判定', 'SCM 负责物料与供应', '客户负责 golden sample 签样', '项目经理负责发布准备推进', '管理层负责 MP Release 决策'],
...
const OBT_GATE_STANDARDS: Record<string, SOPGateStandard> = {
  ...
  pvt: {
    ...
    responsibleRoles: ['ME/工厂负责试产执行', 'QA 负责质量判定', 'SCM 负责物料与物流', '客户负责放行', '项目经理负责发布准备推进', '管理层负责 MP Release 决策'],
...
export const NPD_PHASES: SOPPhase[] = [
  {
    ...
    tasks: [
      { id: 'c1', name: '市场调研与竞品分析', desc: '收集市场数据、竞品拆解、定价分析', owner: '产品经理/BD', visibleRoles: ['pm', 'manager', 'owner'], guide: '1) 收集 TOP 5 竞品的硬件参数、定价、销量数据\n2) 拆解 2-3 款关键竞品（成本结构、用户评价）\n3) 输出竞品对比矩阵' },
  ...
  },
  {
    ...
    tasks: [
      { id: 'mp1', name: '首批量产 (Ramp-up)', desc: '小批量爬坡，监控良率', owner: '工厂/项目经理', visibleRoles: ['scm', 'qa', 'pm', 'manager', 'owner'], guide: '1) 首批 1K-5K 爬坡\n2) 日良率监控与异常响应\n3) 关键工位驻厂支持\n4) 客户样品确认' },
...
export const IDR_PHASES: SOPPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'im5', name: '市场与渠道切换', desc: '同步新版本图片、文案、包装和售后识别规则', owner: '产品经理/市场/销售', visibleRoles: ['pm', 'manager', 'owner'], guide: '1) 更新产品图片、详情页、说明书、包装图和渠道资料\n2) 明确新旧版本命名、SKU、条码、销售区域和上市日期\n3) 向销售、客服和售后说明版本差异和识别方式' },
...
export const JDM_PHASES: SOPPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: 'jm1', name: '首批量产 (Ramp-up)', desc: '小批爬坡，监控良率', owner: '工厂/项目经理', visibleRoles: ['scm', 'qa', 'pm', 'manager', 'owner'], guide: '1) 首批爬坡\n2) 日良率监控\n3) 客户样品确认' },
...
export const OBT_PHASES: SOPPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'os4', name: '客户样品确认', desc: '送样客户并收集确认意见', owner: '项目经理', visibleRoles: ['pm', 'qa', 'manager', 'owner'], guide: '1) 送样\n2) 收集意见\n3) 整改闭环' },
  ...
  },
  {
    ...
    tasks: [
      { id: 'om1', name: '首批量产', desc: '首批量产与爬坡', owner: '工厂/项目经理', visibleRoles: ['scm', 'qa', 'pm', 'manager', 'owner'], guide: '1) 首批量产\n2) 日良率监控\n3) 客户确认' },
