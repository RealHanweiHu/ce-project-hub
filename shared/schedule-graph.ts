...
export const SCHEDULE_GRAPH: G = {
  ...
  drv_core_special_validation: [6, "drv_core_function_sample"],
  drv_electronics_sample_build: [5, "drv_common_evt_build"],
  drv_electronics_special_test: [5, "drv_electronics_sample_build"],
  drv_software_dev_integration: [6, "drv_common_evt_build"],
  drv_software_special_validation: [5, "drv_software_dev_integration"],
  ...
  drv_common_system_regression: [5, "drv_common_evt_build", "drv_battery_special_validation", "drv_core_special_validation", "drv_electronics_special_test", "drv_software_special_validation", "drv_structure_t1_t2_validation", "drv_id_cmf_standard_confirmation"],
  drv_common_software_validation: [5, "drv_common_evt_build"],
  drv_common_evt_issue_close: [3, "drv_common_system_regression", "drv_common_software_validation"],
  drv_common_evt_gate: [1, "drv_common_evt_issue_close"],
  drv_common_dvt_build: [5, "drv_common_evt_gate"],
  drv_common_reliability_test: [8, "drv_common_dvt_build"],
  drv_common_safety_cert_test: [8, "drv_common_dvt_build"],
  drv_common_accessory_confirm: [3, "drv_common_dvt_build"],
  drv_common_packaging_validation: [4, "drv_common_dvt_build"],
  drv_common_logistics_validation: [4, "drv_common_dvt_build"],
  drv_common_dvt_issue_close: [3, "drv_common_reliability_test", "drv_common_safety_cert_test", "drv_common_accessory_confirm", "drv_common_packaging_validation", "drv_common_logistics_validation"],
  drv_common_dvt_gate: [1, "drv_common_dvt_issue_close"],
  drv_common_fixture_confirmation: [4, "drv_common_dvt_gate"],
  drv_common_eol_program_confirm: [4, "drv_common_dvt_gate"],
  drv_common_pvt_trial: [6, "drv_common_fixture_confirmation", "drv_common_eol_program_confirm"],
  drv_common_pvt_quality_close: [4, "drv_common_pvt_trial"],
  drv_common_release_files: [3, "drv_common_pvt_quality_close"],
  drv_common_pvt_release_gate: [1, "drv_common_fixture_confirmation", "drv_common_eol_program_confirm", "drv_common_pvt_trial", "drv_common_pvt_quality_close", "drv_common_release_files"],
